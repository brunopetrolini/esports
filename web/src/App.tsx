...
import logo from "./assets/esports-logo.svg";
    ...
    <div className="max-width-[1344px] mx-auto flex flex-col items-center my-20">
      ...
      <div className="grid grid-cols-6 gap-6 mt-16">
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/game-one.png" alt="League of Legends" />
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/game-two.png" alt="Dota 2" />
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0">
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/game-tree.png" alt="Counter Strike" />
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0">
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/game-four.png" alt="Apex Legends" />
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0">
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/game-five.png" alt="Fortnite" />
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0">
        ...
        <a href="" className="relative rounded-lg overflow-hidden">
          <img src="/game-six.png" alt="World of Warcraft" />
          <div className="w-full pt-16 pb-4 px-4 bg-game-gradient absolute bottom-0 left-0 right-0">
